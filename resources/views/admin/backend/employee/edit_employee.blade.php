...
@section('title')
<title>Edit {{ $employees->employee_name}}'s Employee Details</title>
@endsection
@section('admin')
...
<div class="container-full">
			...
			<div class="box-body">
			  <div class="row">
				<div class="col">
					...
					<section class="content">
			 			<div class="box-header with-border">
				  			<h4 class="box-title" style="text-decoration: underline;">Enter The Number Of Days Worked This Month </h4>
						</div>
					 	<div class="row">
							<div class="col-12">	
	...
	<section class="content">
		...
		<div class="box">
			<div class="box-header with-border">
			  <h5 class="box-title">Update Employee Details </h5>
			</div>
			<!-- /.box-header -->
			<div class="box-body">
			  <div class="row">
				<div class="col">
					...
					<section class="content">
						...
						<div class="text-xs-right">
							<input type="submit" class="btn btn-rounded btn-primary mb-5" value="Update Employee Details">
						</div>
					</form>
						...
						<div class="col-md-12">
							<div class="box bt-3 border-info">
							  <div class="box-header">
					 			<h4 class="box-title">Employee Image <strong>Update</strong></h4>
							  </div>

						
										<form method="post" action="{{ route('update-employee-image') }}" enctype="multipart/form-data">
								        @csrf
									     <input type="hidden" name="id" value="{{ $employees->id }}">
									    	<input type="hidden" name="old_img" value="{{ $employees->employee_image }}">
													<div class="row row-sm">
															<div class="col-md-3">

																<div class="card">
																  <img src="{{ asset($employees->employee_image) }}" class="card-img-top" style="height: 130px; width: 280px;">
																  <div class="card-body">
																     
																    <p class="card-text"> 
																    	<div class="form-group">
																    		<label class="form-control-label">Change Image <span class="tx-danger">*</span></label>
																    <input type="file" name="employee_image" class="form-control" onChange="mainThamUrl(this)"  >
																     <img src="" id="mainThmb">
																    	</div> 
																    </p>
