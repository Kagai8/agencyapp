...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Receipt PP{{$paymentplan->id }}S </title>
      ...
      <table border="0" cellspacing="0" cellpadding="0">
        ...
        <tbody>
          <tr>
            ...
            <td class="desc">{{$paymentplan->amount}}</td>
        ...
        <tfoot>
          ...
          <tr>
            ...
            <td>KSH {{$paymentplan->original_amount - $paymentplan->customer->customer_discount}}</td>
          </tr>
        </tfoot>
      </table>
