	...
	<section class="content">
		...
		<div class="box">
			<div class="box-header with-border">
			  <h5 class="box-title">Update Customer Account </h5>
			</div>
			<!-- /.box-header -->
			<div class="box-body">
			  <div class="row">
				<div class="col">
  					<form method="post" action="{{ route('update-customer-details') }}" enctype="multipart/form-data" >
		 			@csrf
		 			<input type="hidden" name="id" value="{{ $customer->id }}">
		 			<section class="content">

			 			<div class="box-header with-border">
				  			<h4 class="box-title" style="text-decoration: underline;">1. Update Customer Personal Details </h4>
						</div>
					 	<div class="row">
							<div class="col-12">	
									...
									<div class="col-md-6">
	 									<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="controls">
												<input type="phone" name="customer_phone_no" class="form-control" value="{{$customer->customer_phone_no}}">
									...
									<div class="col-md-6">
	 									<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="controls">
												<input type="text" name="customer_kra_pin" class="form-control" value="{{$customer->customer_kra_pin}}">
									...
									<div class="col-md-6">
	 									<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="controls">
												<input type="text" name="customer_national_id" class="form-control" value="{{$customer->customer_national_id}}">
									...
									<div class="col-md-6">
	 									<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="controls">
												<input type="text" name="customer_contact_person_name" class="form-control" value="{{$customer->customer_contact_person_name}}">
									...
									<div class="col-md-6">
	 									<div class="form-group">
											<div class="form-group">
												...
												<div class="controls">
												<input type="email" name="customer_contact_person_email" class="form-control" value="{{$customer->customer_contact_person_email}}">
									...
									<div class="col-md-12">
	 									<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="controls">
												<input type="phone" name="customer_contact_person_phone" class="form-control" value="{{$customer->customer_contact_person_phone}}">
									...
									<div class="col-md-6">
	 									<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="controls">
												<input type="text" name="customer_premium_price" class="form-control" value="{{$customer->customer_premium_price}}">
											     @error('customer_premium_price') 
												 <span class="text-danger">{{ $message }}</span>
												 @enderror
									 	  		</div>
		 									</div>
									...
									<div class="col-md-6">
	 									<div class="form-group">
											<div class="form-group">
												...
												<div class="controls">
												<input type="text" name="customer_credit_limit" class="form-control" value="{{$customer->customer_credit_limit}}">
